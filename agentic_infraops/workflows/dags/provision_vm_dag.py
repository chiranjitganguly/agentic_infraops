...
def task_dry_run_validate(**context: object) -> None:
    ...
    from agentic_infraops.skills.gcp_compute.provisioner import create_vm
    ...
    async def _run() -> None:
        from agentic_infraops.mcp_servers.gcp_resource import server as gcp_server
        from agentic_infraops.mcp_servers.postgres import server as pg_server
...
def task_register_backstage(**context: object) -> None:
    ...
    async def _run() -> None:
        from agentic_infraops.mcp_servers.backstage import server as bs_server
...
def task_rollback_vm(**context: object) -> None:
    ...
    from agentic_infraops.skills.gcp_compute.rollback import rollback_vm
