...
from agentic_infraops.contracts.shared.correlation import new_correlation_context, set_correlation_context
...
async def dispatch_email_request(message: dict) -> tuple[str, str] | None:
    ...
    """
    from agentic_infraops.mcp_servers.gmail import server as gmail
